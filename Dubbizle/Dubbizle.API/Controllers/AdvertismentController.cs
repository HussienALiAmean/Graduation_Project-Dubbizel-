...
namespace Dubbizle.API.Controllers
{
    ...
    public class AdvertismentController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllBySubCategoryID(int subCategoryID, string UserId)
        {
            ...
            List<Advertisment> advertisments=(List<Advertisment>)advertismentService.GetAllBySubCategoryID("Advertisment_FiltrationValuesList.filtrationValue", "AdvertismentImagesList", "Advertisment_RentOptionList.RentOption", subCategoryID);
            bool IsSaved = false;
